...
export const HERBIVORE_BEHAVIOR_IDS: HerbivoreBehaviorId[] = ['default', 'forager'];

/** All valid carnivore behavior profile IDs, used for random selection at spawn. */
export const CARNIVORE_BEHAVIOR_IDS: CarnivoreBehaviorId[] = ['default', 'aggressive', 'passive'];
